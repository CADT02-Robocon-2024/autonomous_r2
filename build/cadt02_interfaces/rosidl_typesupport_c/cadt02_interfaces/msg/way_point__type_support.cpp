...
static const _WayPoint_type_support_symbol_names_t _WayPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cadt02_interfaces, msg, WayPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cadt02_interfaces, msg, WayPoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cadt02_interfaces, msg, WayPoint)() {
  return &::cadt02_interfaces::msg::rosidl_typesupport_c::WayPoint_message_type_support_handle;
}
