...
static const _SmartDriver_type_support_symbol_names_t _SmartDriver_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cadt02_interfaces, msg, SmartDriver)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cadt02_interfaces, msg, SmartDriver)),
  }
};
...
{
  return &::cadt02_interfaces::msg::rosidl_typesupport_cpp::SmartDriver_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cadt02_interfaces, msg, SmartDriver)() {
  return get_message_type_support_handle<cadt02_interfaces::msg::SmartDriver>();
}
