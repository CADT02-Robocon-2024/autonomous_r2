...
def show_team_buttons():
    ...
    red_button = ctk.CTkButton(main_frame, text="Red Team", height=180, command=show_red_team_buttons, fg_color="red")
    red_button.grid(row=0, column=0, padx=10, pady=10, sticky="ew")

    blue_button = ctk.CTkButton(main_frame, text="Blue Team", height=180, command=show_blue_team_buttons, fg_color="blue")
...
def show_red_team_buttons():
    ...
    back_button = ctk.CTkButton(main_frame, text="Back", width=580, command=show_team_buttons)
